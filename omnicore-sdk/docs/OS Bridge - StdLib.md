...
| `thread.spawn(f!callback, arg!*void)!*thread_handle` | Yeni thread başlatır                 | **threading sistemi**, OS bağımsız    |
...
Böylece **CoreModule.exf** tamamen OS-bridge olurken, **Core.nx** saf çekirdek fonksiyonları barındırıyor.
