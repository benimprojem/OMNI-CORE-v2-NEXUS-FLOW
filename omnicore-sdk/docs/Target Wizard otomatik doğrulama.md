...
target dosyası occ ile derleme yapılırken seçilir.
-t win64  gibi burada occ bu win64.target dosyasını /targets klaasöründe bulur. Yoksa hata üretir ve target/ klasöründekileri  listeler kullanıcadan seçmesini ister.
occ ir dosyasına target dosyasındakileri işeler, ve parser a aktarır. Target direktifleri optimizer, codegen ve linker için önemlidir.
